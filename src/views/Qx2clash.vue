              ...
              <template v-if="['3'].includes(advanced)">
                <el-form-item label="配置文件:">
                  <el-upload
                    ...
                    :limit="1"
                    :http-request="handleUploadAction"
...
<script>
import { queryConfig } from '../config/index'
...
export default {
  ...
  methods: {
    ...
    confirmUploadConfig() {
      ...
      this.handlerUploadFn({ data });
    },
    backendSearch(queryString, cb) {
      let backends = this.options.customBackendOptions;
    ...
    handleUploadChange(file, fileList) {
      this.configFileList = fileList.slice(-3);
    },
